package IBM_8b_10b_Encoder is
    ...
    procedure Encode(B: in Byte; T: out Ten_Bits; RD: in out Running_Disp);

    --To verify that Running Disparity is being preserved, use this version
    procedure Decode(T: in Ten_Bits; B: out Byte; RD: in out Running_Disp);

    procedure Decode(T: in Ten_Bits; B: out Byte);
